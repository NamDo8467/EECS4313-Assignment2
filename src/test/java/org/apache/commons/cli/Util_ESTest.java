...
public class Util_ESTest extends Util_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      boolean boolean0 = Util.isEmpty(":uGYgM");
      assertFalse(boolean0);
  }

  @Test(timeout = 4000)
  public void test02()  throws Throwable  {
      String string0 = Util.stripLeadingHyphens("-.y\"r?*n7g%^d.i]");
      assertEquals(".y\"r?*n7g%^d.i]", string0);
  }
  ...
  public void test04()  throws Throwable  {
      String string0 = Util.stripLeadingHyphens(".y\"r?*nT7g%^d.i]");
      assertEquals(".y\"r?*nT7g%^d.i]", string0);
  }

  @Test(timeout = 4000)
  public void test05()  throws Throwable  {
      String string0 = Util.stripLeadingAndTrailingQuotes("\"\"%e95wKMhtb\"");
      assertEquals("\"\"%e95wKMhtb\"", string0);
  }

  @Test(timeout = 4000)
  public void test06()  throws Throwable  {
      String string0 = Util.stripLeadingAndTrailingQuotes("\"&Y#");
