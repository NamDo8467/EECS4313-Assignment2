...
public class AlreadySelectedException_ESTest extends AlreadySelectedException_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Option option0 = new Option((String) null, "HZOV]%unuNTnFa3l/Pk", true, "HZOV]%unuNTnFa3l/Pk");
  ...
  public void test06()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option((String) null, "org.apache.commons.text.similarity.SimilarityCharacterInput", true, (String) null);
      AlreadySelectedException alreadySelectedException0 = new AlreadySelectedException(optionGroup0, option0);
  ...
  public void test07()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option((String) null, "f;j 8g8m,?4{AY", false, (String) null);
      AlreadySelectedException alreadySelectedException0 = new AlreadySelectedException(optionGroup0, option0);
  ...
  public void test08()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("u", "u", false, "`.x{|yV;_BA+?AP8X+");
      AlreadySelectedException alreadySelectedException0 = new AlreadySelectedException(optionGroup0, option0);
      option0.setArgName("Zx:?J1z2$~\"< |+");
      Option option1 = alreadySelectedException0.getOption();
