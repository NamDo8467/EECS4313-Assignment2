...
public class OptionValidator_ESTest extends OptionValidator_ESTest_scaffolding {
  ...
  public void test4()  throws Throwable  {
      try { 
        OptionValidator.validate("@/U,#EBt-E||@");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option '@/U,#EBt-E||@' contains an illegal character : '/'.
         //
         verifyException("org.apache.commons.cli.OptionValidator", e);
      }
  }
  ...
  public void test5()  throws Throwable  {
      String string0 = OptionValidator.validate("vQP-sNmjOj2V");
      assertEquals("vQP-sNmjOj2V", string0);
  }
