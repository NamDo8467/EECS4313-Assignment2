...
public class OptionGroup_ESTest extends OptionGroup_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      Option option0 = new Option("1cKT", "1cKT");
      optionGroup0.setSelected(option0);
      String string0 = optionGroup0.getSelected();
      assertEquals("1cKT", string0);
  }
  ...
  public void test08()  throws Throwable  {
      OptionGroup optionGroup0 = new OptionGroup();
      String string0 = "\\u";
      Option option0 = new Option("XP03v7", "XP03v7", true, string0);
      OptionGroup optionGroup1 = optionGroup0.addOption(option0);
      Option option1 = new Option("$h", "$h", true, "$h");
      optionGroup0.addOption(option1);
      String string1 = optionGroup1.toString();
      assertEquals("[-XP03v7 \\u, -$h $h]", string1);
  }
  ...
  public void test14()  throws Throwable  {
      ...
      try { 
        ...
        fail("Expecting exception: Exception");
         ...
         //
         // The option '$h' was specified but an option from this group has already been selected: 'XP03v7'
         //
         verifyException("org.apache.commons.cli.OptionGroup", e);
      }
  }
