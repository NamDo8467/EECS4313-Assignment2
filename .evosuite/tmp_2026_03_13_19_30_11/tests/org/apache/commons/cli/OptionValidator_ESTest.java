...
public class OptionValidator_ESTest extends OptionValidator_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      String string0 = OptionValidator.validate("Fi");
  ...
  public void test4()  throws Throwable  {
      try { 
        OptionValidator.validate("=,i=|w.RcL");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test5()  throws Throwable  {
      try { 
        OptionValidator.validate("H-_H8]ZokifGL/1");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option 'H-_H8]ZokifGL/1' contains an illegal character : ']'.
         //
         verifyException("org.apache.commons.cli.OptionValidator", e);
      }
  }
